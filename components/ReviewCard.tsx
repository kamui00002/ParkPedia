    ...
    <div className="border-t pt-6">
      <div className="flex items-start">
        ...
        <div className="ml-4 flex-1">
          ...
          <div className="mt-3">
            <button className="flex items-center text-sm text-gray-600 hover:text-green-600 border rounded-full px-3 py-1 transition-colors">
               <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-1">
