      ...
      <div className="bg-white rounded-lg shadow-xl p-8">
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full p-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none"
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-500">{photos.length === 0 ? '選択されていません' : `${photos.length}枚選択中`}</span>
              </div>
              {photos.length > 0 && (
          ...
          <div className="mt-8 pt-4 border-t flex justify-end space-x-3">
            ...
            <button type="submit" className="px-6 py-2 bg-green-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-green-700">
              この公園を登録する
            </button>
          </div>
        </form>
